...
import { FEED_UPDATES, MOCK_GIGS } from '../constants';
import { useAuth } from '../context/AuthContext';
import { ThumbsUp, MessageCircle, Share2, MapPin, Clock, CheckCircle } from 'lucide-react';
            ...
            <div className="flex items-start gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  {post.user.role === 'atumwa' ? 'Messenger' : post.user.role === 'admin' ? 'Admin' : 'Client'} • {post.time}
                </p>
              </div>
            </div>
